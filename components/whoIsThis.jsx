...
export default function WhoIsThis() {
  const lists = [
    ...
    "This course is follows Test Driven Development (TDD), no previous testing knowledge required",
    "We use Nextjs (A Reactjs Framework), knowledge of basic Javascript or jquery is important.",
    ...
    <div className="py-24 px-4 h-full bg-gradient-t-teall text-white">
      ...
      <div className="absolute z-0 mt-64 -ml-2 opacity-50">
        ...
        <div className="flex flex-wrap justify-center">
          <h2 className="text-3xl w-full text-center md:text-5xl">Who is this for?</h2>
